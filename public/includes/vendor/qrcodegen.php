...
//---------------------------------------------------------------------
//
// Vendored 2026-07-02 from kazuhikoarase/qrcode-generator (GitHub), php/qrcode.php.
// Wrapped in the QrCodeGen namespace only — PHP class names are case-insensitive,
// so the unmodified library's `class QRCode` would fatally collide with this
// project's own `class QrCode` (includes/QrCode.php) if both loaded unqualified.
// `define()`'d constants below are unaffected by the namespace (define() always
// targets the global table), so QR_ERROR_CORRECT_LEVEL_* stay referenceable
// unqualified from global-namespace callers. No other changes made to this file.
namespace QrCodeGen;
